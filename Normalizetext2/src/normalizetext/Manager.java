...
public class Manager {
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("C:\\Users\\Dell\\Documents\\NetBeansProjects\\Normalize Text\\src\\normalizetext\\input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Dell\\Documents\\NetBeansProjects\\Normalize Text\\src\\normalizetext\\output.txt", true)));
            String line;
